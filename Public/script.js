...
//           formStatus.innerHTML = '<div class="alert alert-success" style="background: #d4edda; color: #155724; padding: 10px; border-radius: 5px; margin-top: 15px;">Thank you! Your message has been sent.</div>';
...
//         formStatus.innerHTML = '<div class="alert alert-error" style="background: #f8d7da; color: #721c24; padding: 10px; border-radius: 5px; margin-top: 15px;">Sorry, there was an error sending your message. Please try again.</div>';
